    ...
    def _build_system_prompt_parts(self, system_message: str = None) -> Dict[str, str]:
        ...
        if "dtc_site_search_context" in self.valid_tool_names and "dtc_site_search_record" in self.valid_tool_names:
            tool_guidance.append(
                ...
                "has_skill=true, immediately call skill_view(name=skill_view_name) "
                "and follow the loaded site skill's Minimal Successful Path exactly, "
                "including any canonical redirect target or category URL. When a site "
                "skill exists, it overrides the generic requirement to start at the "
                "user-provided URL; do not re-explore URLs, search boxes, buttons, "
                "snapshots, or clicks listed in the skill's Do Not Do section. "
                "If dtc_site_search_context returns has_skill=false, call "
