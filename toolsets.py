...
_HERMES_CORE_TOOLS = [
    ...
    # Cronjob management
    "cronjob",
    # Feishu messaging (gated on gateway running via check_fn)
    "send_message",
...
TOOLSETS = {
    ...
    "messaging": {
        "description": "Feishu/Lark messaging: send messages to configured chats.",
        "tools": ["send_message"],
        "includes": []
    },
    ...
    "hermes-gateway": {
        "description": "Gateway toolset - Feishu/Lark messaging platform tools",
        "tools": [],
